namespace Animal
{
    ...
    var listaMascotas:Array<Mascotas> = new Array<Mascotas>();
    
    export function buscarFilter()
    {
    ...
    export function guardar()
    {
        ...
        var cantVidas:number = document.getElementById("cantVidas").value;
        var raza:string = document.getElementById("raza").value;
        var idRow:number;
        if(document.getElementById("tipoPajaro").value == "1")
        {
            var tipoPajaro:eTipo = eTipo.Loro;
        }else if(document.getElementById("tipoPajaro").value == "2")
        {
            var tipoPajaro:eTipo = eTipo.Rapiña;
        }
        ...
        switch(document.getElementById("tipoMascota").value)
        {
            ...
            case "3":
                if(nombre != "")
                {
                    ...
                    var miPajaro:Pajaro = new Pajaro(nombre,tipoPajaro);
    ...
    export function modificar()
    {
        ...
        {
            var nombre:string = document.getElementById("nameM").value;
            var raza:string = document.getElementById("raza").value;
